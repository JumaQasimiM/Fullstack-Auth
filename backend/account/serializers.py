...
class UserSerializer(serializers.ModelSerializer):
    ...
    def validate_password(self, password):
        ...
        if first_name and first_name.lower() in password.lower():
             raise serializers.ValidationError('Password must not contain first name')
        
        if last_name and last_name.lower() in password.lower():
            raise serializers.ValidationError('Password must not contain last name')
    ...
    """
    Create and return a new user using validated data.
    """
